...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2022 at 03:11 AM
...
INSERT INTO `machine` (`id`, `machine`, `category_id`, `options`) VALUES
(5, 'ASPEC C1 (CHOCOLOCO)', '', ''),
(6, '', '', 'MACHINE'),
(7, 'ASPEC C1 (CHOCOLOCO)', '8', ''),
(8, 'eveqv', '', ''),
(13, 'ASPEC C1 (CHOCOLATE)', '16', ''),
(14, 'kris', '', '');
...
INSERT INTO `operator` (`id`, `name`, `options_id`) VALUES
(4, 'Total Time', ''),
(5, 'Testing', ''),
(6, 'Actual Time', '');
...
INSERT INTO `product` (`id`, `product`, `options_id`) VALUES
(3, 'BABBLE JOE GUM', ''),
(4, 'BREWERS', ''),
(5, 'CHOOWI DOOWI', ''),
(6, 'LIPPS', '');
...
INSERT INTO `shift` (`id`, `shift`, `options_id`) VALUES
(3, 'A', ''),
(4, 'B', '');
...
INSERT INTO `variant` (`id`, `variant`, `product_id`) VALUES
(2, 'zxczc', '2'),
(3, 'xfgdfg', '1'),
(4, 'APPLE', ''),
(6, 'APPLE', '6');
...
INSERT INTO `workcenter` (`id`, `workcenter`, `product_id`) VALUES
(3, '420 s Packaging', ''),
(4, '50 s & 25 s Packaging', '');
