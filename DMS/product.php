				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<textarea name="product" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-secondary edit_position" type="button" data-id="<?php echo $row['id'] ?>" data-product="<?php echo $row['product'] ?>" data-options_id="<?php echo $row['options_id'] ?>"  >Edit</button>
...
<script>
	...
	$('.delete_position').click(function(){
		_conf("Are you sure to delete this product?","delete_position",[$(this).attr('data-id')])
	})
	...
	fetch("ProductSMS.php", { method: "POST", body: data })
	.then(res => res.text())
