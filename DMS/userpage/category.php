							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-secondary edit_department" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>"  >Edit</button>
...
<script>
	...
	$('.delete_department').click(function(){
		_conf("Are you sure to delete this category?","delete_department",[$(this).attr('data-id')])
	})
	...
	fetch("CategorySMS.php", { method: "POST", body: data })
	.then(res => res.text())
