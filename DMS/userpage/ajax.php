...
if($action == "save_options"){
	$save = $crud->save_options();
	if($save)
		echo $save;
}
if($action == "delete_options"){
	$save = $crud->delete_options();
	if($save)
		echo $save;
}
if($action == "save_operator"){
	$save = $crud->save_operator();
	if($save)
		echo $save;
}
if($action == "delete_operator"){
	$save = $crud->delete_operator();
	if($save)
		echo $save;
}
...
if($action == "save_shift"){
	$save = $crud->save_shift();
	if($save)
		echo $save;
}
if($action == "delete_shift"){
	$save = $crud->delete_shift();
	if($save)
		echo $save;
}
if($action == "save_variant"){
	$save = $crud->save_variant();
	if($save)
		echo $save;
}
if($action == "delete_variant"){
	$save = $crud->delete_variant();
	if($save)
		echo $save;
}
...
if($action == "save_workcenter"){
	$save = $crud->save_workcenter();
	if($save)
		echo $save;
}
if($action == "delete_workcenter"){
	$save = $crud->delete_workcenter();
	if($save)
		echo $save;
}
