...
Class Action {
	...
	function save_machine(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO machine set ".$data);
		}else{
			$save = $this->db->query("UPDATE machine set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_machine(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM machine where id = ".$id);
		if($delete)
			return 1;
	}
	function save_operator(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO operator set ".$data);
		}else{
			$save = $this->db->query("UPDATE operator set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_operator(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM operator where id = ".$id);
		if($delete)
			return 1;
	}
	...
	function save_shift(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO shift set ".$data);
		}else{
			$save = $this->db->query("UPDATE shift set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_shift(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM shift where id = ".$id);
		if($delete)
			return 1;
	}
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO variant set ".$data);
		}else{
			$save = $this->db->query("UPDATE variant set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_variant(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM variant where id = ".$id);
		if($delete)
			return 1;
	}
			function save_workcenter(){
		extract($_POST);
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO workcenter set ".$data);
		}else{
			$save = $this->db->query("UPDATE workcenter set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_workcenter(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM workcenter where id = ".$id);
		if($delete)
			return 1;
	}
	...
	function delete_category(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO options set ".$data);
		}else{
			$save = $this->db->query("UPDATE options set ".$data." where id=".$id);
		}
		if($save)
			return 1;
	}
	function delete_options(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM options where id = ".$id);
		if($delete)
			return 1;
	}
